...
# Test 2:
    ...
    answer = integers([[1,2,3],['four',5,6],('seven',8)])
    print('Expected is:', expected)
    print('Actual is:  ', answer)
...
def integers(sequence_of_sequences):
    ...
    for k in range(len(sequence_of_sequences)):
        for r in range(len(sequence_of_sequences[k])):
            if isinstance(sequence_of_sequences[k][r],int) == True:
                list = list + [sequence_of_sequences[k][r]]
    return list
    # -------------------------------------------------------------------------
...
def big_letters(sequence_of_sequences):
    ...
    for k in range(len(sequence_of_sequences)):
        for r in range(len(sequence_of_sequences[k])):
            if isinstance(sequence_of_sequences[k], str) == True:
                if sequence_of_sequences[k][r].isupper() == True:
                    string = string + sequence_of_sequences[k][r]
    return string
    # -------------------------------------------------------------------------
